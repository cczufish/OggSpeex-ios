...
- (IBAction)playButtonClicked:(id)sender {
    ...
    if ( ! self.isPlaying) {
      ...
      //  NSString *file = [NSString stringWithFormat:@"%@",[[NSBundle mainBundle] pathForResource:@"gauss" ofType:@"spx"]];
        
        NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
        NSString *documentsDirectory = [paths objectAtIndex:0];
        NSString *filePath = [documentsDirectory stringByAppendingPathComponent:@"gauss.spx"];
